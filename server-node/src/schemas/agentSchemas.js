  ...
  heartbeatSchema: z.object({
    ...
    body: z
      .object({
        ...
        disk_usages: z.array(z.object({
          mount: z.string().max(64).nullish(),
          volume_label: z.string().max(128).nullish(),
          total_gb: z.number().nullish(),
          used_gb: z.number().nullish(),
          free_gb: z.number().nullish(),
