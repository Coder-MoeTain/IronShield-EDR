...
CREATE TABLE IF NOT EXISTS av_scan_policies (
  ...
  realtime_debounce_seconds INT UNSIGNED NOT NULL DEFAULT 2,
  device_control_enabled BOOLEAN NOT NULL DEFAULT FALSE,
  web_url_protection_enabled BOOLEAN NOT NULL DEFAULT TRUE,
  removable_storage_action VARCHAR(16) NOT NULL DEFAULT 'audit',
